...
// 경로 상의 점들이 있겠지
// 걔네는 회전하는 애들의 이동 행렬의 인자로 들어갈거야
// 걔네를 저장하는 버퍼를 만든 다음에 쉐이더로 보내주면 그릴 수 있겠지...?
...
void init_obj()
{
	...
	gluQuadricDrawStyle(center_sphere, GLU_LINE); // 도형스타일 
	//gluQuadricDrawStyle(center_sphere, GLU_FILL); // 도형스타일 
